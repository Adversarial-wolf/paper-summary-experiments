...
# Identify outliers among the subsampled examples
from sklearn.ensemble import IsolationForest
clf = IsolationForest(random_state=0)
clf.fit(X_train) # train the isolation forest over the entire training set, like the DP RF 
all_distances_outlier_scores = list(clf.decision_function([X_train[i] for i in subsampled_examples])) # the lower, the more abnormal
...
dict_res = {
    ...
    'all_distances_outlier_scores': all_distances_outlier_scores,
}
